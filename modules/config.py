...
Config = {
    ...
    "chromedriver_path": r"C:\Program Files (x86)\Google\Chrome\Application\chromedriver.exe",  # if windows 'chromedriver.exe'
    ...
    "amount_of_account": 2, #amount of account you want to create make sure it doesnt exceed 50 for better performance
